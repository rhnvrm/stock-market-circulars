---
category: compliance
circular_id: f51347aa5fea7275
date: '2025-11-21'
description: SEBI permits Investment Advisers to communicate certified past performance
  to clients using specified performance metrics and mandatory disclosure requirements.
draft: false
guid: https://www.bseindia.com/markets/MarketInfo/DispNoticesNCirculars.aspx?Noticeid={AC878128-D0C7-461F-8957-8EC1DDE69191}&noticeno=20251121-3&dt=11/21/2025&icount=3&totcount=74&flag=0
impact: medium
impact_ranking: medium
importance_ranking: medium
justification: Affects Investment Advisers only, establishes standardized framework
  for performance communication with clients, requires specific disclosures and certification
  by ICAI/ICMAI members
...
processing:
  attempts: 1
  content_hash: f7c030d12baeb107
  processed_at: '2025-11-21T18:58:18.195122'
  processor_version: '2.0'
  stage: completed
  status: published
published_date: '2025-11-21T07:03:35+00:00'
rss_url: https://www.bseindia.com/markets/MarketInfo/DispNoticesNCirculars.aspx?Noticeid={AC878128-D0C7-461F-8957-8EC1DDE69191}&noticeno=20251121-3&dt=11/21/2025&icount=3&totcount=74&flag=0
severity: medium
source: bse
stocks: []
tags:
...
1. **Absolute Returns (INR terms)** - Returns for assumed investment amount over specified time period
2. **Absolute Returns (%)** - Percentage returns over specified time period
3. **CAGR** - Compounded average annual growth rate
4. **Rolling Returns** - Returns over overlapping time periods within total timeframe
5. **Hits/Misses** - Success ratios represented as:
...
6. **Performance Charts** - Charts showing NAV or price of recommended securities
7. **Range of Returns** - Maximum/minimum returns or categorization across performance ranges

## Compliance Requirements

Investment Advisers must ensure all performance communications include:

1. Name/nature of service/advice/recommendation of IA
2. Applicable time period for the performance
3. Information/details explaining performance calculation methodology
4. Assumptions made during performance calculation
5. Disclaimers specified in SEBI circular
