---
category: compliance
circular_id: 96d62088377f0d61
date: '2025-12-10'
description: BSE notifies trading members that clients with non-validated KYC status
  (on hold) uploaded to KRA between November 1-30, 2025 will be prohibited from trading
  effective December 20, 2025.
draft: false
guid: https://www.bseindia.com/markets/MarketInfo/DispNoticesNCirculars.aspx?Noticeid={A76265E6-7678-4413-BD24-E0648B9603CE}&noticeno=20251210-27&dt=12/10/2025&icount=27&totcount=78&flag=0
impact: high
impact_ranking: high
importance_ranking: high
justification: Critical compliance requirement that will prohibit trading for non-compliant
  clients starting December 20, 2025. Affects all trading members and their clients
  with non-validated KYC status.
pdf_url: https://www.bseindia.com/markets/MarketInfo/DownloadAttach.aspx?id=20251210-27&attachedId=
processing:
  attempts: 1
  content_hash: bc0ef66e1867537d
  processed_at: '2025-12-10T18:55:52.282730'
  processor_version: '2.0'
  stage: completed
  status: published
published_date: '2025-12-10T12:03:01+00:00'
rss_url: https://www.bseindia.com/markets/MarketInfo/DispNoticesNCirculars.aspx?Noticeid={A76265E6-7678-4413-BD24-E0648B9603CE}&noticeno=20251210-27&dt=12/10/2025&icount=27&totcount=78&flag=0
severity: high
source: bse
stocks: []
tags:
...
1. Review the non-compliant client list provided at path: \EQ\Transaction\December-2025\10-12-2025
2. Notify affected clients whose KYC records are on hold status
3. Ensure clients complete KYC validation requirements before December 20, 2025
4. Block debit transactions in accounts of deceased investors reported by KRA
5. Suspend all transactions in trading accounts of deceased investors
6. Inactivate/close UCC (Unique Client Code) in all stock exchanges for deceased investors
7. Monitor daily demise data shared by KRA
8. Track KRA compliance status for restoration of trading permissions on T+1 basis

**For Clients:**

1. Complete KYC validation with KRA if currently on hold status
2. Ensure all documentation meets validation requirements
3. Comply before December 20, 2025 to avoid trading restrictions
