---
category: compliance
circular_id: 5964184132e47428
date: '2025-11-27'
description: SEBI notifies the Fifth Amendment to LODR Regulations 2015, introducing
  changes to related party transaction thresholds, definitions, and approval requirements
  for listed entities and their subsidiaries.
draft: false
guid: https://www.bseindia.com/markets/MarketInfo/DispNoticesNCirculars.aspx?Noticeid={29208547-AE14-4AD6-BBC5-1A2499EB086C}&noticeno=20251127-63&dt=11/27/2025&icount=63&totcount=66&flag=0
impact: high
impact_ranking: high
importance_ranking: high
justification: Major regulatory amendment affecting all listed entities' related party
  transaction framework, requiring immediate compliance and process updates for approval
  mechanisms and disclosure thresholds
pdf_url: https://www.bseindia.com/markets/MarketInfo/DownloadAttach.aspx?id=20251127-63&attachedId=2bde0496-6a27-4f7b-9491-1c0f698663c8
processing:
  attempts: 1
  content_hash: e137b2240c723f2d
  processed_at: '2025-11-27T18:36:06.864867'
  processor_version: '2.0'
  stage: completed
  status: published
published_date: '2025-11-27T15:59:27+00:00'
rss_url: https://www.bseindia.com/markets/MarketInfo/DispNoticesNCirculars.aspx?Noticeid={29208547-AE14-4AD6-BBC5-1A2499EB086C}&noticeno=20251127-63&dt=11/27/2025&icount=63&totcount=66&flag=0
severity: high
source: bse
stocks: []
tags:
...
1. **Policy Updates**: Listed entities must update their Related Party Transaction policies to incorporate new definitions and thresholds

2. **Process Implementation**: Establish mechanisms to track and monitor subsidiary-level related party transactions exceeding ₹1 crore

3. **Audit Committee Procedures**: Revise audit committee approval processes to include subsidiary transactions meeting the new criteria

4. **Schedule XII Review**: Refer to Schedule XII of LODR Regulations for specific materiality thresholds (entities must obtain and review Schedule XII)

5. **Disclosure Framework**: Update disclosure templates and processes to capture expanded definition of related parties including key managerial personnel and relatives

6. **Training**: Conduct training for finance, secretarial, and compliance teams on new requirements

7. **System Updates**: Modify internal tracking systems to identify transactions involving:
