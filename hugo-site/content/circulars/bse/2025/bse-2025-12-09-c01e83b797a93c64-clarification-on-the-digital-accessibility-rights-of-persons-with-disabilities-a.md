---
category: compliance
circular_id: c01e83b797a93c64
date: '2025-12-08'
description: SEBI issues clarifications on digital accessibility compliance requirements
  for regulated entities, extending the deadline for readiness reporting to March
  31, 2026, and introducing accessibility complaint mechanisms on SCORES.
draft: false
guid: https://www.bseindia.com/markets/MarketInfo/DispNoticesNCirculars.aspx?Noticeid={96AF80F3-EBEC-4B1B-9D20-DDC14E7AB3F4}&noticeno=20251209-10&dt=12/09/2025&icount=10&totcount=71&flag=0
impact: high
impact_ranking: high
importance_ranking: high
justification: Applies to all regulated entities (stock brokers, investment advisors,
  mutual funds, depositories, etc.) with mandatory digital accessibility compliance
  requirements and new investor complaint mechanisms. Significant operational impact
  requiring platform audits and remediation.
pdf_url: https://www.bseindia.com/markets/MarketInfo/DownloadAttach.aspx?id=20251209-10&attachedId=6bdb16a1-9477-459a-9e5d-c0f4e871a275
processing:
  attempts: 1
  content_hash: 9bf453447a6108a9
  processed_at: '2025-12-09T15:56:31.233877'
  processor_version: '2.0'
  stage: completed
  status: published
published_date: '2025-12-09T09:10:54+00:00'
rss_url: https://www.bseindia.com/markets/MarketInfo/DispNoticesNCirculars.aspx?Noticeid={96AF80F3-EBEC-4B1B-9D20-DDC14E7AB3F4}&noticeno=20251209-10&dt=12/09/2025&icount=10&totcount=71&flag=0
severity: high
source: bse
stocks: []
tags:
...
**Key Modifications:**
1. **Investor Charter Update**: "Investors' Right to have digital accessibility" to be formally included in all RE-specific Investor Charters published by SEBI

2. **Compliance Mechanism Change**: Original requirement for appointing accessibility auditor by December 14, 2025 replaced with readiness status submission requirement

3. **SCORES Enhancement**: New accessibility complaint category introduced allowing investors to lodge platform accessibility issues directly against REs

4. **Audit Requirements**: Formalized requirement for periodic accessibility audits by certified accessibility professionals

## Compliance Requirements

**For All Regulated Entities:**

1. **Status Reporting (By March 31, 2026)**:
...
8. Depositories
9. KYC Registration Agencies (KRAs)
10. Merchant Bankers (MBs)
11. Mutual Funds (MFs)/Asset Management Companies (AMCs)
12. Portfolio Managers
13. Registrar to an Issue and Share Transfer Agents (RTAs)
14. Stock Exchanges
15. Venture Capital Funds (VCFs)
...
**Market-Wide Impact:**
This circular affects the entire securities market ecosystem, requiring comprehensive digital accessibility compliance across all regulated entities. Estimated impact on thousands of platforms operated by brokers, depositories, mutual funds, exchanges, and other intermediaries.
...
**Timeline Relief:**
Extension from December 14, 2025 to March 31, 2026 provides approximately 3.5 additional months for REs to assess readiness and prepare compliance status reports, acknowledging implementation challenges.

**Legal Foundation:**
Circular issued under Section 11(1) of the Securities and Exchange Board of India Act, 1992, to protect investor interests and regulate securities markets, providing strong regulatory backing for accessibility requirements.