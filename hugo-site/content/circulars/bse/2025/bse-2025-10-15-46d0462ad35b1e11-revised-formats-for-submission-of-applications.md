---
category: compliance
circular_id: 46d0462ad35b1e11
date: '2025-10-15'
description: BSE introduces revised formats and documentation requirements for submission
  of applications related to change in designated directors of corporate trading members.
draft: false
guid: https://www.bseindia.com/markets/MarketInfo/DispNoticesNCirculars.aspx?Noticeid={CEDC4199-1813-4901-AC3B-0CF4CEC9AEE2}&noticeno=20251015-48&dt=10/15/2025&icount=48&totcount=48&flag=0
impact: medium
impact_ranking: medium
importance_ranking: medium
justification: Procedural update affecting corporate trading members seeking to change
  designated directors. Requires updated documentation and compliance with revised
  formats.
...
processing:
  attempts: 1
  content_hash: 49b6957c933c3eb6
  processed_at: '2025-10-15T15:31:01.627491'
  processor_version: '2.0'
  stage: completed
  status: published
published_date: '2025-10-15T15:11:54+00:00'
rss_url: https://www.bseindia.com/markets/MarketInfo/DispNoticesNCirculars.aspx?Noticeid={CEDC4199-1813-4901-AC3B-0CF4CEC9AEE2}&noticeno=20251015-48&dt=10/15/2025&icount=48&totcount=48&flag=0
severity: medium
source: bse
stocks: []
tags:
...
1. **CDD-1**: Submit application for change in designated director(s)
2. **CDD-2**: Board resolutions as applicable (5 formats provided for different scenarios)
3. **CDD-3**: Self-certified or authorized signatory certified PAN card copy
4. **CDD-4**: Valid proof of address (Aadhaar with consent, Passport, Voter ID, utility bills, or bank statements not older than 2 months)
5. **CDD-5**: Experience certificate on letterhead proving minimum 2 years capital market experience
6. **CDD-6**: Educational qualification proof (minimum HSC), certified by CA/CS
7. **CDD-7**: Standard undertaking with full disclosure
