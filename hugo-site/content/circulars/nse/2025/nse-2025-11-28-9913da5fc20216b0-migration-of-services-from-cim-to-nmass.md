...
circular_id: 9913da5fc20216b0
date: '2025-11-28'
description: NSE Clearing discontinues Collateral Interface for Members (CIM) and
  migrates collateral management, EMI, and reporting services to NMASS platform effective
  December 15, 2025.
draft: false
guid: https://nsearchives.nseindia.com/content/circulars/CMPT71541.zip
impact: high
impact_ranking: high
importance_ranking: high
justification: Critical system migration affecting all clearing members and custodians
  requiring mandatory role configuration changes before December 15, 2025 to avoid
  operational disruptions in collateral management services.
pdf_url: https://nsearchives.nseindia.com/content/circulars/CMPT71541.zip
processing:
  attempts: 1
  content_hash: 4ff14f13a5d49e40
  processed_at: '2025-11-28T12:57:28.687337'
  processor_version: '2.0'
  stage: completed
  status: published
published_date: '2025-11-28T00:00:00+05:30'
rss_url: https://nsearchives.nseindia.com/content/circulars/CMPT71541.zip
severity: high
source: nse
stocks: []
tags:
...
1. **Role Configuration**: Super Admin users must create or modify roles in NMASS to assign new collateral management services
2. **Timeline**: Complete role setup between December 01-15, 2025
3. **User Access**: Ensure all users requiring collateral management access have appropriate roles assigned in NMASS
4. **Testing**: Verify access to all required functionalities before December 15, 2025
5. **Training**: Review provided user manual (Version 2.0) for NMASS collateral management module
